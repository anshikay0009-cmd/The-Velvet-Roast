        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="space-y-3 pt-2">
              ...
              <div className="flex items-center space-x-3 text-xs">
                ...
                <div>
                  ...
                  <p className="text-brand-text/50">+91 (22) 6911 2000</p>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-5 space-y-4" id="footer-maps">
            ...
            <div className="relative w-full h-[180px] bg-brand-secondary border border-brand-border rounded-2xl overflow-hidden shadow-inner grayscale contrast-110 brightness-95 hover:grayscale-0 transition-all duration-500">
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3774.218556391456!2d72.83023607598686!3d18.922245987189196!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7d1e8c764e5ad%3A0xe530d9cebc9d494!2sRegal%20Cinema!5e0!3m2!1sen!2sin!4v1718873000000!5m2!1sen!2sin" 
                width="100%" 
                height="100%" 
                style={{ border: 0 }} 
                ...
                title="The Velvet Roast Cafe Regal Cinema Colaba Mumbai Location"
                className="absolute inset-0"
              />
            </div>

            <p className="font-sans text-[11px] text-brand-text/50 leading-relaxed font-light">
              Find us at <span className="font-semibold text-brand-text/70">Ground Floor, Cecil Court, Mahakavi Bhushan Marg, Colaba, Mumbai 400039</span>. Transit: 10 mins taxi from CSMT Station / adjacent to Regal Cinema.
            </p>
          </div>
