...
export const MENU_ITEMS: MenuItem[] = [
  // COFFEE SECTION
  {
    ...
    description: 'Espresso with edible charcoal, premium house-crafted Himalayan rose syrup, and silky oat milk. Rich, dramatic slate color.',
    price: 450,
    category: 'coffee',
    rating: 9.8,
  ...
  },
  {
    ...
    description: 'Double shot of rich single-origin Chikmagalur espresso, spiced turmeric syrup, organic honey, steamed almond milk, and edible gold flakes.',
    price: 420,
    category: 'coffee',
    rating: 9.5,
  ...
  {
    id: 'maple-cold-brew',
    name: 'Salted Jaggery Cold Foam Brew',
    description: '24-hour cold steep topped with a dense cloud of salted organic palm jaggery cold foam. Garnished with cracked pepper.',
    price: 390,
    category: 'coffee',
    rating: 9.6,
  ...
  },
  {
    ...
    name: 'Malabar Pistachio Shakerato',
    description: 'Espresso shaken with ice and handcrafted local pistachio syrup, served straight up with a crushed salted-pistachio rim.',
    price: 480,
    category: 'coffee',
    rating: 9.7,
  ...
  {
    id: 'fig-tart',
    name: 'Fresh Fig & Whipped Artisanal Cheese Tart',
    description: 'Artisanal sourdough honey pastry rimmed with crumbled organic local goat cheese, layered with sweet Western Ghats purple figs and fresh rosemary.',
    price: 490,
    category: 'bakery',
    rating: 9.3,
  ...
  // MAINS SECTION
  {
    ...
    description: 'Charred seed-dense sourdough, crushed Nilgiris avocado cream, heirloom micro-greens, edible flower confetti, and hot white truffle oil drizzle.',
    price: 750,
    category: 'mains',
    rating: 9.7,
  ...
  },
  {
    ...
    description: 'Sprouted quinoa, hand-massaged local organic kale, crunchy harissa chickpeas, beetroot hummus, lemon-tahini massage, and baked herb falafel.',
    price: 790,
    category: 'mains',
    rating: 9.4,
  ...
  },
  {
    ...
    description: 'Slow-scrambled, soufflé-textured organic pasture eggs over a toasted home-baked fluffy brioche crown, loaded with crispy house Malabar chili crunch.',
    price: 680,
    category: 'mains',
    rating: 9.5,
  ...
  // DESSERTS SECTION
  {
    ...
    description: 'Luxuriously smooth single-origin espresso and cardamom egg custard, finished with an incredibly glassy torched sugar crust and fresh local berries.',
    price: 490,
    category: 'desserts',
    rating: 9.4,
  ...
  },
  {
    ...
    description: 'Deep premium single-origin Belgian dark chocolate brownie bake with a molten lava interior, sprinkled with flaky Lonavala river salt crystals.',
    price: 450,
    category: 'desserts',
    rating: 9.8,
  ...
  },
  {
    ...
    description: 'Dazzling crisp-edged meringue basket infused with organic rosewater, piled with pillowy coconut cream, wild Nilgiris blackberries, and fresh raspberries.',
    price: 520,
    category: 'desserts',
    rating: 9.7,
